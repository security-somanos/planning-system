...
function SortableVehicleAssignment({
  ...
  return (
    <div ref={setNodeRef} style={style} className="rounded-lg border border-zinc-200 p-3 bg-zinc-50">
      ...
      <div>
        <div className="mb-1 flex items-center justify-between">
          ...
          {(() => {
            ...
            if (capacity !== undefined) {
              return (
                <span className={`text-xs ${currentCount > capacity ? "text-red-600 font-medium" : "text-zinc-500"}`}>
        ...
        {(() => {
          ...
          const selectedParticipants = participants.filter((p) => va.participantIds && va.participantIds.includes(p.id));
  ...
  return (
    <AdminLayout title={isNew ? "New Movement" : `Edit Movement: ${movement?.title ?? ""}`}>
      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="mb-1 text-sm font-medium">Vehicle Assignments</div>
          <DndContext
            sensors={sensors}
          ...
          >
            ...
            <DragOverlay>
              {activeId ? (() => {
                ...
                if (!va) return null;
                return (
                  <div className="rounded-lg border border-zinc-200 p-3 bg-zinc-50 opacity-90 rotate-2 shadow-lg w-full max-w-md">
                    <div className="flex items-start gap-2 mb-3">
